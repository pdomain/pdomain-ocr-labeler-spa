...
class FilesystemStorage:
    ...
    async def put_bytes(self, key: str, data: bytes) -> None:
        ...
        await anyio.to_thread.run_sync(lambda: path.parent.mkdir(parents=True, exist_ok=True))  # type: ignore[attr-defined]  # pyright: ignore[reportAttributeAccessIssue]
    ...
    async def delete(self, key: str) -> None:
        ...
        await anyio.to_thread.run_sync(_delete)  # type: ignore[attr-defined]  # pyright: ignore[reportAttributeAccessIssue]
    ...
    async def list_keys(self, prefix: str) -> list[str]:
        ...
        return await anyio.to_thread.run_sync(_walk)  # type: ignore[attr-defined]  # pyright: ignore[reportAttributeAccessIssue]
