...
class PredictorCache:
    ...
    which accepts whatever ``pd_book_tools.ocr.doctr_support``
    produces.
    """
    ...
    def _build(self, key: PredictorKey) -> Any:
        ...
        Lazy import of ``pd_book_tools.ocr.doctr_support`` so the
        ...
        """
        doctr_support = importlib.import_module("pd_book_tools.ocr.doctr_support")
