...
| 20 | [`20-glyph-annotations.md`](20-glyph-annotations.md) | Glyph-level annotations — manual review and dataset-export path shipped; no predictor exists or will be built |
